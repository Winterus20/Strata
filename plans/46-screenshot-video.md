...
- **GPU-accelerated:** wgpu texture readback
...
impl ScreenshotManager {
    pub async fn capture(&self, texture: &wgpu::Texture) -> Result<PathBuf>;
    pub async fn capture_no_hud(&self, texture: &wgpu::Texture) -> Result<PathBuf>;
}
```
...
impl VideoCapture {
    ...
    pub fn capture_frame(&mut self, texture: &wgpu::Texture);
}
```
